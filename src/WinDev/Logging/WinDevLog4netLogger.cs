...
namespace WinDev.Logging {
    [Serializable]
    public class WinDevLog4netLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(WinDevLog4netLogger);       

        public WinDevLog4netLogger(log4net.Core.ILogger logger, WinDevLog4netFactory factory) {
        ...
        internal WinDevLog4netLogger() {
        }

        internal WinDevLog4netLogger(ILog log, WinDevLog4netFactory factory)
        ...
        protected internal WinDevLog4netFactory Factory { get; set; }
