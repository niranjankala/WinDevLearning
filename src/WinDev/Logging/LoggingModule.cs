...
namespace WinDev.Logging
{
    ...
    public class LoggingModule : Module
    {
        ...
        {
            // by default, use WinDev's logger that delegates to Castle's logger factory
            ...
            {
                moduleBuilder.RegisterType<WinDevLog4netFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
            }
            else
            {
                moduleBuilder.RegisterType<WinDevSerilogFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
            }
