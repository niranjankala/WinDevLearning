...
namespace WinDev.Logging {
    [Serializable]
    public class WinDevSerilogLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(WinDevSerilogLogger);       

        public WinDevSerilogLogger(log4net.Core.ILogger logger, WinDevSerilogFactory factory) {
        ...
        internal WinDevSerilogLogger() {
        }

        internal WinDevSerilogLogger(ILog log, WinDevSerilogFactory factory)
        ...
        protected internal WinDevSerilogFactory Factory { get; set; }
        ...
        public bool IsTraceEnabled => Logger.IsEnabledFor(Level.Trace);
